...
void draw_static_mob(MobID::T mob_id, Renderer &ctx, MobRenderAttributes attr) {
    ...
    switch(mob_id) {
        ...
        case MobID::kShinyLadybug:
            ...
            else if (mob_id == MobID::kFatDarkLadybug) SET_BASE_COLOR(0xff962921)
            else if (mob_id == MobID::kManbug) SET_BASE_COLOR(0xff962921)
            ...
            ctx.fill(1);
            {
                ...
                else if (mob_id == MobID::kFatDarkLadybug) ctx.set_fill(Renderer::HSV(base_color, 1.2));
                else if (mob_id == MobID::kManbug) ctx.set_fill(Renderer::HSV(base_color, 1.2));
